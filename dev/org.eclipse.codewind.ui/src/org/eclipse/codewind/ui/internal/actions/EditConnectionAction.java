 ...
 */
public class EditConnectionAction extends SelectionProviderAction {
	...
	public void run() {
		if (connection == null) {
			...
			Logger.logError("EditConnectionAction ran but no connection was selected"); //$NON-NLS-1$
			return;
		}

		EditConnectionDialog dialog = new EditConnectionDialog(Display.getDefault().getActiveShell(), connection);
